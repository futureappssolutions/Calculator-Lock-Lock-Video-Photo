...
import calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.Adapter.AudioFoldersImportAdapter;
...
import calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.Adapter.AudioSystemFileAdapter;
...
public class AudiosImportActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void Import() {
        ...
        new Thread() { // from class: calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.Activity.AudiosImportActivity.10
