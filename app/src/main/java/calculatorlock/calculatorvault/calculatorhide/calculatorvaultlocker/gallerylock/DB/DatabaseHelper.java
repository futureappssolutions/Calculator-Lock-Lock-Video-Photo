...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static {
        INSERT_AUDIO_PLAYLIST = "INSERT INTO tblAudioPlayList ( PlayListName, FlPlayListLocation, IsFakeAccount , SortBy, ModifiedDateTime  ) VALUES ( 'My Playlist', '" +
                StorageOptionsCommon.STORAGEPATH_1 +
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (i2 == 2) {
            ...
            File[] listFiles = new File(this.context.getFilesDir() + "/audio/").listFiles();
