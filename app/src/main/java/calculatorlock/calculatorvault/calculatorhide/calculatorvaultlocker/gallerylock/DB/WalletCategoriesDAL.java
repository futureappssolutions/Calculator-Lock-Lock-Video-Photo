...
public class WalletCategoriesDAL {
    ...
    public void addWalletCategoriesInfoInDatabase(WalletCategoriesFileDB_Pojo walletCategoriesFileDB_Pojo) {
        ...
        this.constants.getClass();
        contentValues.put("WalletCategoriesFileIconIndex", walletCategoriesFileDB_Pojo.getCategoryFileIconIndex());
        this.constants.getClass();
        contentValues.put("WalletCategoriesFileSortBy", walletCategoriesFileDB_Pojo.getCategoryFileSortBy());
        this.constants.getClass();
        contentValues.put("WalletCategoriesFileIsDecoy", walletCategoriesFileDB_Pojo.getCategoryFileIsDecoy());
