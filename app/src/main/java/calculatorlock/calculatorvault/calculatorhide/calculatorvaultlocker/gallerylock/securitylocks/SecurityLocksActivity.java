...
import calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.Activity.CalculatorPinSetting;
...
public class SecurityLocksActivity extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.securityLocksListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.securitylocks.SecurityLocksActivity.1
