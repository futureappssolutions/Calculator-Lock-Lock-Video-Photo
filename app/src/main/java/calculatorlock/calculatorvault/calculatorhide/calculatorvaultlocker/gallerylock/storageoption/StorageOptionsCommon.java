package calculatorlock.calculatorvault.calculatorhide.calculatorvaultlocker.gallerylock.storageoption;
...
public class StorageOptionsCommon {
    ...
    public static String AUDIOS_TEMP_FOLDER = STORAGE + APP_PATHNAME + "PlayLists/FLCipherTemp/";
    public static String TODOLIST = STORAGE + APP_PATHNAME + "ToDoLists/";
    public static String AUDIOS = STORAGE + APP_PATHNAME + "PlayLists/";
