...
public class GoogleAppLovinAds {
    ...
    public static void preLoadAds(Activity activity) {
        if (!(Preferences.getActive_Weekly().equals("true") || Preferences.getActive_Monthly().equals("true") || Preferences.getActive_Yearly().equals("true"))) {
            if (Preferences.getAds_name().equals("a")) {
    ...
    public static void preLoadFull(Activity activity) {
        ...
        InterstitialAd.load(activity, Preferences.getGoogle_full(), adRequest,
    ...
    public static void preLoadAppLovinFull(Activity activity) {
        maxInterstitialAd = new MaxInterstitialAd(Preferences.getAppLovin_full(), activity);
    ...
    public static void preLoadAppLovinBanner(Activity activity) {
        maxAdView = new MaxAdView(Preferences.getAppLovin_banner(), activity);
    ...
    public static void preLoadNative(Activity activity) {
        AdLoader.Builder builder = new AdLoader.Builder(activity, Preferences.getGoogle_native()).forNativeAd(nativeAd -> {
            mNativeAd = nativeAd;
    ...
    public static void preLoadApLovinNative(Activity activity) {
        ...
        nativeAdLoader = new MaxNativeAdLoader(Preferences.getAppLovin_native(), activity);
