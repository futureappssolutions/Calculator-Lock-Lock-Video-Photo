...
public class AccelerometerManager {
    ...
    private static SensorEventListener sensorEventListener = new SensorEventListener() { // from class: com.calculator.vaultlocker.panicswitch.AccelerometerManager.1
