...
public class PanicSwitchActivity extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.toolbar.setNavigationOnClickListener(new View.OnClickListener() { // from class: com.calculator.vaultlocker.panicswitch.PanicSwitchActivity.1
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.calculator.vaultlocker.panicswitch.PanicSwitchActivity.2
        ...
        this.btnFlick.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.calculator.vaultlocker.panicswitch.PanicSwitchActivity.3
        ...
        this.btnShake.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.calculator.vaultlocker.panicswitch.PanicSwitchActivity.4
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
        ...
        this.btnPalmOnScreen.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.calculator.vaultlocker.panicswitch.PanicSwitchActivity.5
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
